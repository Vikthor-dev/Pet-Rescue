 ...
 export default {
   data(){
    ...
    components: {
      ...
      filteredPostShelter () {
      return this.posts.filter(post => post.postedBy.toLowerCase().includes(this.search) && post.animal=='Cat' || post.description.toLowerCase().includes(this.search) && post.animal=='Cat')
    },
        convertTimestamp() {
